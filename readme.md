📊 De una intuición simple a un sistema basado en datos: Rediseñando beneficios con análisis de datos

Para quienes no me conocen, desde los 6 años practico Pelota a Paleta. Como aficionado a esta disciplina, formo parte de la organización del 'Torneo Amistad', un circuito anual de 10 fechas que convoca jugadores de todo el país.
...
PD: Les dejo el link a un dashboard interactivo para visualizar estos resultados y al repo.
Dashboard:
Repositorio:

#DataScience #Analytics #DecisionesBasadasEnDatos #BusinessIntelligence #DataDriven #PelotaPaleta